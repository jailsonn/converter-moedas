...
// e o then -> retorna as informações em JSON.
async function converterMoedas() {
  ...
  if (select.value === "€ Euro") {
    ...
    inputMoedas.innerHTML = valorEnEuros.toLocaleString("de-DE", {
      style: "currency",
      currency: "EUR",
    });
  }

  textoReal.innerHTML = inpuValorEmReais.toLocaleString("pt-br", {
    style: "currency",
    currency: "BRL",
  });
}
